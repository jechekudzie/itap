            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0" id="page-title">Package Category</h4>
                ...
                <div class="row">
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    <div class="flex-grow-1">
                                        ...
                                        <a href="{{route('package-categories.index')}}" class="btn btn-info btn-sm add-btn">
                                ...
                                <table style="width: 100%;" id="buttons-datatables"
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="buttons-datatables"
                                            ...
                                            style="width: 336.4px;">Package Category
                                        </th>
                                    ...
                                    @foreach($packageCategories as $packageCategory)
                                        <tr class="even">
                                            ...
                                            <td>
                                                <!-- Edit Button -->
                                                <a href="javascript:void(0);" class="edit-button btn btn-sm btn-primary" data-name="{{ $packageCategory->name }}" data-slug="{{ $packageCategory->slug }}" data-category="{{ $packageCategory->service_category_id }}" title="Edit">
                                                    <i class="fa fa-pencil"></i>
                                                </a>

                                                <!-- Delete Button -->
                                                <form action="{{ route('package-categories.destroy', $packageCategory->slug) }}" method="POST" onsubmit="return confirm('Are you sure?');" style="display: inline-block;">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="col-xxl-3">
                        <div class="card border card-border-light">
                            <div class="card-header">
                                <h6 id="card-title" class="card-title mb-0">Add  Package Category</h6>
                            </div>
                            <div class="card-body">
                                <form id="edit-form" action="{{route('package-categories.store')}}" method="post" enctype="multipart/form-data">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.edit-button').on('click', function() {
                ...
                $('#name').val(name);
                $('#card-title').text('Edit - ' + name + ' Package Category');
                $('#page-title').text('Edit - ' + name + ' Package Category');
            });

            // Click event for adding a new item
            $('#new-button').on('click', function() {
                // Clear the form, set action for creation, method to POST, and button text to Add New
                $('#edit-form').attr('action', 'admin/package-categories/store');
                $('input[name="_method"]').val('POST');
                submitButton.text('Add New');
                $('#name').val('');
                $('#card-title').text('Add Package Category');
                $('#page-title').text('Add New Package Category');
            });
        });
