            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0" id="page-title">Package</h4>
                ...
                <div class="row">
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    <div class="flex-grow-1">
                                        ...
                                        <a href="{{route('packages.index')}}" class="btn btn-info btn-sm add-btn">
                                ...
                                <table style="width: 100%;" id="buttons-datatables"
                                    ...
                                    @foreach($packages as $package)
                                        <tr class="even">
                                            ...
                                            <td>
                                                <!-- Edit Button -->
                                                <a href="javascript:void(0);" class="edit-button btn btn-sm btn-primary" data-name="{{ $package->name }}" data-slug="{{ $package->slug }}"  title="Edit">
                                                    <i class="fa fa-pencil"></i>
                                                </a>

                                                <!-- Delete Button -->
                                                <form action="{{ route('packages.destroy', $package->slug) }}" method="POST" onsubmit="return confirm('Are you sure?');" style="display: inline-block;">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="col-xxl-3">
                        <div class="card border card-border-light">
                            <div class="card-header">
                                <h6 id="card-title" class="card-title mb-0">Add  Package</h6>
                            </div>
                            <div class="card-body">
                                <form id="edit-form" action="{{route('packages.store')}}" method="post" enctype="multipart/form-data">
