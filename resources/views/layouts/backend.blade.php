...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title> @yield('title', 'iTAP Media - Administration') </title>
                        ...
                        <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="nav-link-icon"><span data-feather="pie-chart"></span></span><span
                                        class="nav-link-text">iTAP Media</span>
                                </div>
                            </a>
                            <div class="parent-wrapper label-1">
                                <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                    id="nv-home">
                                    <li class="collapsed-nav-item-title d-none">Home - iTAP Media</li>
                                    <li class="nav-item">
                                        ...
                                        <a class="nav-link {{ Request::routeIs('services.index') ? 'active' : '' }}" href="{{route('services.index')}}"
                                           data-bs-toggle="" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text">Services</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ Request::routeIs('package-categories.index') ? 'active' : '' }}" href="{{route('package-categories.index')}}"
                                           data-bs-toggle="" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span class="nav-link-text">Package Categories</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ Request::routeIs('packages.index') ? 'active' : '' }}" href="{{route('packages.index')}}" data-bs-toggle="" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text">iTAP Media Packages</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                ...
                <a class="navbar-brand me-1 me-sm-3" href="{{url('/admin')}}">
                    <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center">
                           ...
                           {{-- <p class="logo-text ms-2 d-none d-sm-block">iTAP Media</p>--}}
                        </div>
                    </div>
                </a>
            </div>
        ...
        <footer class="footer position-absolute">
            <div class="row g-0 justify-content-between align-items-center h-100">
                <div class="col-12 col-sm-auto text-center">
                    <p class="mb-0 mt-2 mt-sm-0 text-900">iTAP Media<span
